...
# Main Function
def main(gblVariables, user_id, conversation_id, conversation_url, conversation_title, 
         prompt_flag, time_available_mins, query):

    path_folder_vdb                         = '/Users/naaz/data1/official/myfunprojects/WPIHackathon/vectorDBStore/'
    path_folder_users                       = '/Users/naaz/data1/official/myfunprojects/WPIHackathon/users/'
    ...
    system_prompt = (
        ...
        "300-400 words, provide answer to given question: "
        "\n\n"
        "{context}"
        )
    if prompt_flag == 'Questions':
        system_prompt = (
            ...
            "when this is the case. Respond courteously to greetings such as 'Hello' or 'Good morning.' If you are "
...
response            = main(None, user_id, conversation_id, None, None, 
...
gblVariables, questions = main(gblVariables, user_id, conversation_id, conversation_url, conversation_title, 
                               prompt_flag, time_available_mins, query)
...
gblVariables, answer = main(gblVariables, user_id, conversation_id, conversation_url, conversation_title, 
                               prompt_flag, time_available_mins, query)
...
gblVariables, summary = main(gblVariables, user_id, conversation_id, conversation_url, conversation_title, 
                               prompt_flag, time_available_mins, query)
